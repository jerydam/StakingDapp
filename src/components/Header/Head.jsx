        ...
        <>
            <div className="fixed inset-x-0 top-0 z-30 flex h-14 items-center justify-between gap-12 px-4 transition left-72 backdrop-blur-sm  ring-1 ring-zinc-900/10">
                ...
                <div className="block max-w-md flex-auto">
                    <button
                        type="button"
                        className="h-8 w-full items-center gap-2 rounded-full bg-white pl-2 pr-3 text-sm text-zinc-500 ring-1 ring-zinc-900/10 transition hover:text-blue-900 flex focus:[&amp;:not(:focus-visible)]:outline-none"
                    >
                ...
                <div className="flex items-center gap-5">
                    <nav className="hidden md:block">
                        <ul className="flex items-center gap-8">
                            <li>
                                <a className="text-sm leading-5 text-zinc-600 transition hover:text-blue-900" href="/">API</a>
                            </li>
                            <li>
                                <a className="text-sm leading-5 text-zinc-600 transition hover:text-blue-900" href="/#">Documentation</a>
                            </li>
                            <li><a className="text-sm leading-5 text-zinc-600 transition hover:text-blue-900" href="/#">Support</a></li>
                        </ul>
                    </nav>
